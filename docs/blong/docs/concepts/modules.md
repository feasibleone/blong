...
An example TypeScript configuration is available in the blong/test here
[tsconfig.json](https://github.com/feasibleone/blong/blob/main/core/test/tsconfig.json).
