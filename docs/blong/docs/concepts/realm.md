...
To achieve a modular approach, the business logic is separated in different realms.
...
Realms allow development teams to focus their expertise in the details
related to the part of the business process and implement it end to end
