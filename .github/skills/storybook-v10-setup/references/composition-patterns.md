...
For projects with multiple packages containing stories, Storybook provides several composition
strategies.
...
const config: StorybookConfig = {
    stories: [
        ...
        '../../realm/blong-login/src/**/*.stories.tsx',
    ...
    webpackFinal: async config => {
        config.resolve.alias = {
            ...
            '@feasibleone/blong-login': path.resolve(__dirname, '../../realm/blong-login/src'),
        };
        return config;
    },
};
...
```bash
# Terminal 1
cd tools/blong-log && npm run storybook  # Port 6006

# Terminal 2
cd core/blong-rest && npm run storybook  # Port 6007

# Terminal 3
cd realm/blong-login && npm run storybook  # Port 6008
