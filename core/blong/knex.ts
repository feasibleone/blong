...
// ============================================================================
// - 'events' -> Minimal EventEmitter interface defined below
// - 'stream' -> Minimal stream interfaces defined below
// - 'tarn' -> Pool type simplified
// - 'tls' -> ConnectionOptions simplified
// - './result' -> Registry type defined inline
// - './tables' -> Tables type defined inline
...
// ============================================================================
// Minimal Tarn Pool Interface (replacing 'tarn' module)
// ============================================================================
...
interface Pool<T> {
    ...
    destroyAllNow(): PromiseLike<void>;
    numUsed(): number;
    numFree(): number;
...
// ============================================================================
// Registry and Tables Types (replacing './result' and './tables')
// ============================================================================
    ...
    export class QueryBuilder {
        static extend(
            ...
            fn: <TRecord extends {} = any, TResult extends {} = unknown[]>(
                ...
                | Promise<
                      Knex.QueryBuilder<TRecord | TResult> | DeferredKeySelection.Resolve<TResult>
                  >,
        ): void;
    }
...
declare namespace Knex {
    ...
    interface OnConflictQueryBuilder<TRecord extends {}, TResult> {
        ...
        merge(
            data?: Extract<DbRecord<ResolveTableType<TRecord, 'update'>>, Record<string, any>>,
        ): QueryBuilder<TRecord, TResult>;
    }
    ...
    interface QueryInterface<TRecord extends {} = any, TResult = any> {
        ...
        // Aggregation
        count: AsymmetricAggregation<TRecord, TResult, Lookup<Registry, 'Count', number | string>>;
    ...
    interface Select<TRecord extends {} = any, TResult = unknown[]>
        extends AliasQueryBuilder<TRecord, TResult>, ColumnNameQueryBuilder<TRecord, TResult> {
        (): QueryBuilder<TRecord, TResult>;
    ...
    interface Table<TRecord extends {} = any, TResult = any> {
        ...
        <TRecord2 extends {} = {}, TResult2 = DeferredKeySelection.ReplaceBase<TResult, TRecord2>>(
            callback: (this: QueryBuilder<TRecord, TResult>) => QueryBuilder<TRecord2, TResult2>,
            options?: TableOptions,
        ): QueryBuilder<TRecord2, TResult2>;
        <TRecord2 extends {} = {}, TResult2 = DeferredKeySelection.ReplaceBase<TResult, TRecord2>>(
            raw: Raw,
    ...
    interface Distinct<TRecord extends {}, TResult = {}[]> extends ColumnNameQueryBuilder<
        TRecord,
        TResult
    > {}
    ...
    interface With<TRecord extends {} = any, TResult = unknown[]>
        extends WithRaw<TRecord, TResult>, WithWrapped<TRecord, TResult> {}
    ...
    interface WhereRaw<TRecord extends {} = any, TResult = unknown[]> extends RawQueryBuilder<
        TRecord,
        TResult
    > {
    ...
    interface AsymmetricAggregation<TRecord extends {} = any, TResult = unknown[], TValue = any> {
        ...
        <TResult2 = AggregationQueryResult<TResult, Dict<TValue>>>(
            ...columnNames: ReadonlyArray<
                Readonly<Record<string, string | string[] | Knex.Raw>> | Knex.Raw | string
            >
        ): QueryBuilder<TRecord, TResult2>;
    }
    ...
    > {
        ...
        <TResult2 = AggregationQueryResult<TResult, Dict<TValue>>>(
            ...columnNames: ReadonlyArray<
                Readonly<Record<string, string | readonly string[] | Knex.Raw>> | Knex.Raw | string
            >
        ): QueryBuilder<TRecord, TResult2>;
    }
    ...
    interface GroupBy<TRecord extends {} = any, TResult = unknown[]>
        extends RawQueryBuilder<TRecord, TResult>, ColumnNameQueryBuilder<TRecord, TResult> {}
    ...
    interface PartitionBy<TRecord extends {} = any, TResult = unknown[]> extends OrderBy<
        TRecord,
        TResult
    > {}
    ...
    interface Except<TRecord extends {} = any, TResult = unknown[]> extends Intersect<
        TRecord,
        TResult
    > {}

    interface Union<TRecord extends {} = any, TResult = unknown[]> extends Intersect<
        TRecord,
        TResult
    > {}

    interface Having<TRecord extends {} = any, TResult = unknown[]> extends WhereWrapped<
        TRecord,
        TResult
    > {
        <K extends keyof TRecord>(
    ...
    interface ColumnNameQueryBuilder<TRecord extends {} = any, TResult = unknown[]> {
        (
            columnName: '*',
        ): QueryBuilder<TRecord, ArrayIfAlready<TResult, DeferredKeySelection<TRecord, string>>>;
    ...
    interface BatchInsertBuilder<TRecord extends {} = any, TResult = number[]> extends Promise<
        ResolveResult<TResult>
    > {
    ...
    interface QueryBuilder<TRecord extends {} = any, TResult = any>
        extends QueryInterface<TRecord, TResult>, ChainableInterface<ResolveResult<TResult>> {
        client: Client;
    ...
    interface ChainableInterface<T = any>
        extends Pick<Promise<T>, keyof Promise<T> & ExposedPromiseKeys>, StringTagSupport {
    ...
    interface Transaction<TRecord extends {} = any, TResult = any[]> extends Knex<
        TRecord,
        TResult
    > {
    ...
    interface TableBuilder {
        ...
        unique(columnNames: string | readonly (string | Raw)[], indexName?: string): TableBuilder;
    ...
    type LifecycleHook = (knexOrTrx: Knex | Transaction, migrations: unknown[]) => Promise<any>;
    ...
    interface Migrator {
        ...
        rollback(config?: MigratorConfigWithLifecycleHooks, all?: boolean): Promise<any>;
...
// ============================================================================
// Generic type-level utilities (internal implementation details)
// ============================================================================
