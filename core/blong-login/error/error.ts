export default {
    'login.refreshTokenExpired': {message: 'Refresh token has expired', statusCode: 401},
    ...
    'login.sessionExpired': {message: 'Session has expired', statusCode: 401},
    'login.invalidCookie': {message: 'Invalid session cookie', statusCode: 401},
