 ...
 * `src/components/Theme/wood.css` (design: `plans/theme/wood-card.png`,
 * textures generated by `scripts/woodAssets.mjs`): luxury oiled-walnut panels
 * with seamless grain and an alpha-channel polished bevel, carved-in woven-mesh
 * input channels, brushed-gold bracket controls, charcoal-steel toggles,
