...
export default handler(({
    ...
    mojaloopP2PTransfer: (
        ...
        group(name)([
            async function lookupParty(assert: typeof Assert, {$meta}) {
            ...
            async function requestQuote(assert: typeof Assert, {lookupParty, $meta}) {
                const {party} = await lookupParty;
            ...
            async function executeTransfer(assert: typeof Assert, {requestQuote, $meta}) {
                ...
                assert.equal(transferCallback.status, 200);
            ...
            async function verifyTransfer(assert: typeof Assert, {executeTransfer, $meta}) {
