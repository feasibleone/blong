...
export default library<{
    ...
    ({
        config: {pciDssMode, lmkIdentifierDefault},
        handler: {
         ...
         * Translates business parameters into the Payshield generateKey command,
         * calls the TCP adapter, and parses the response.
         */
        async generateKey(
            {
                mode,
